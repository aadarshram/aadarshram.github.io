---
layout: post
title: The NUS Young Fellowship Programme
subtitle: A Week in Singapore and Learnings on AI, Research, and Life
...
**"Congratulations! You have been selected for admission to the [2025 NUS Young Fellowship Programme.](https://cde.nus.edu.sg/graduate/2025-nus-young-fellowship/)"**

I blinked. Then I read it again. And then I jumped. You see, I had been hoping to spend my summer doing something meaningful, and this? A fully funded, week-long program at the National University of Singapore, with 100 exceptionally talented peers from 22 countries, all coming together to discuss AI and its impact on the world? This was everything I could’ve hoped for—_and more_.
...
We kicked off with a warm welcome from [Prof. Jessica Pan](https://nus.edu.sg/about/management/jessica-pan), a group photo with fellows from around the world, and a debrief by [Prof. Chai Kah Hin](https://cde.nus.edu.sg/isem/staff/chai-kah-hin/) on this year’s central theme:
...
[Prof. Amirhassan Monajemi](https://www.comp.nus.edu.sg/cs/people/amir/) opened the floor by walking us through a historical timeline—from Boltzmann machines to AlexNet, GANs, transformers, and today’s LLMs and agentic AI. He highlighted a critical shift: we’ve moved from “simulating intelligence” to “learning intelligence”.
...
One point that really stuck with me was **skill degradation**—how relying too heavily on AI might subtly erode our own abilities. For instance, there’s a recent [MIT study](https://arxiv.org/abs/2506.08872) showing how students using LLMs for writing may produce better essays in the short term, but risk losing writing depth over time. It’s a subtle shift, but an important one—and it made me pause and ask myself: _how much of this blog am I really writing on my own?_


## Data-Centric AI for Language Models

This session by [Prof. Bryan Low](https://www.comp.nus.edu.sg/cs/people/lowkh/) was an eye-opener. He shared a compelling argument:
...
Check out [glow.ai](http://glow.ai/) for more on his lab’s work—genuinely fascinating stuff.

![glow_ai](https://github.com/user-attachments/assets/23c2d24d-d83d-4c69-9c1d-08c79c378677)


## Assistive Technology and Thinking Outside the Box

[Prof. Suranga Nanayakkara](https://www.comp.nus.edu.sg/cs/people/suranga/)’s talk was a favorite of mine. It wasn’t about raw technical horsepower, but about **designing with empathy**. He showed how his lab reimagines assistive tech: tools that adapt to humans rather than the other way around.
...
1. **Reframe the problem** – don’t ask “how to make a better alarm clock” but “how to ensure people wake up on time.”
2. **Challenge assumptions** – why rely only on vision when other senses might work better?
3. **Pay attention** – most people tolerate poor solutions; innovators notice what others ignore.
4. **Make it happen** – because talking without building is just noise.

Also: he introduced us to **chindogu**—“unuseless inventions” that are technically usable but wildly impractical. _A fun way to rethink creativity, if you ask me._
...
![poster](https://github.com/user-attachments/assets/dc7f2b37-1e51-49aa-a0e0-59371a74e4bc)
...
<img width="1080" height="1080" alt="singapore" src="https://github.com/user-attachments/assets/97d0e2d5-db9c-48fb-9173-1bb7f3c12336" />
